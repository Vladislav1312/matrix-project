...
void srunner_add_sum_tests(SRunner *sr) {
  Suite *save_v1 = suite_create("Sum");
  TCase *tc_sum = tcase_create("Sum");
  suite_add_tcase(save_v1, tc_sum);

  // Sum fun()

  tcase_add_test(tc_sum, s21_add_test_4);
  tcase_add_test(tc_sum, s21_add_test_5);
  tcase_add_test(tc_sum, s21_add_test_6);
  tcase_add_test(tc_sum, s21_add_test_7);
  tcase_add_test(tc_sum, s21_add_test_8);
  tcase_add_test(tc_sum, s21_add_test_9);
  tcase_add_test(tc_sum, s21_add_test_10);
  tcase_add_test(tc_sum, s21_add_test_11);
  tcase_add_test(tc_sum, s21_add_test_12);
  tcase_add_test(tc_sum, s21_add_test_13);
  tcase_add_test(tc_sum, s21_add_test_14);
  tcase_add_test(tc_sum, s21_add_test_15);
  tcase_add_test(tc_sum, s21_add_test_16);
  tcase_add_test(tc_sum, s21_add_test_17);
  tcase_add_test(tc_sum, s21_add_test_18);
  tcase_add_test(tc_sum, s21_add_test_19);
